...
export const Confetti = memo(() => (
	...
	>
		...
		<path
			id={`a1`}
			className={`confetti-a confetti-0`}
		...
		<path
			id={`a2`}
			className={`confetti-a confetti-3`}
		...
		<circle
			id={`b1`}
			className={`confetti-b confetti-2`}
			cx={`195.2`}
			cy={`232.6`}
			r={`5.1`}
		/>
		<circle
			id={`b2`}
			className={`confetti-b confetti-0`}
			cx={`230.8`}
			cy={`219.8`}
			r={`5.4`}
		/>
		<path
			id={`b3`}
			className={`confetti-b confetti-3`}
		...
		<path
			id={`b5`}
			className={`confetti-b confetti-6`}
		...
		<path
			id={`c1`}
			className={`confetti-c confetti-2`}
		...
		<circle
			id={`c2`}
			className={`confetti-c confetti-0`}
			cx={`178.9`}
			cy={`160.4`}
			r={`4.2`}
		/>
		<circle
			id={`c3`}
			className={`confetti-c confetti-6`}
			cx={`206.7`}
			cy={`144.4`}
			r={`4.5`}
		/>
		<path
			id={`c4`}
			className={`confetti-c confetti-3`}
		...
		<path
			id={`d1`}
			className={`confetti-d confetti-0`}
		...
		<circle
			id={`d2`}
			className={`confetti-d confetti-6`}
			cx={`132.8`}
			cy={`123.6`}
			r={`5.4`}
		/>
